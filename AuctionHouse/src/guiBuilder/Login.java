...
public class Login extends JFrame {
	...
	private void initComponents() {
		...
		romanianMenuItem = new JCheckBoxMenuItem();
		...
		//======== this ========
		setTitle("Auction House - Autentificare");
		...
		//======== menuBar ========
		{
			...
			//======== languageMenu ========
			{
				...
				//---- romanianMenuItem ----
				romanianMenuItem.setText("Romanian");
				languageMenu.add(romanianMenuItem);
			}
		...
		//======== formPanel ========
		{
			...
			((GridBagLayout)formPanel.getLayout()).columnWidths = new int[] {0, 126, 0};
		...
		buttonGroup.add(romanianMenuItem);
	...
	private JCheckBoxMenuItem romanianMenuItem;
