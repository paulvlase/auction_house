 ...
 */
public class Message_Deprecated {
	...
	public Message_Deprecated(MessageType type, String destination) {
	...
	public byte[] asByteArray(){
		byte[] result = new byte[outputStream.size() + Integer.SIZE / Byte.SIZE];
		//Arrays.cop
	...
	public static void main(String[] args) {
		...
		Message_Deprecated message = new Message_Deprecated(MessageType.ACCEPT, "Ghennadi");
