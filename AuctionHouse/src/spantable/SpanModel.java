...
/**
 * A model for use by SpanTable, to hold a set of spans that are to be wider or
 * higher than a single cell.
 * 
...
public interface SpanModel {
	 ...
	 *             if the new span intersects any that are already in the model.
	 */
